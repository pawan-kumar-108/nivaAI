...
class VapiMobileCall implements VapiCall {
  ...
  static Future<VapiMobileCall> create(
    ...
    final createdAt = apiResponse['createdAt'] != null ? DateTime.parse(apiResponse['createdAt'] as String) : DateTime.now();
    final updatedAt = apiResponse['updatedAt'] != null ? DateTime.parse(apiResponse['updatedAt'] as String) : DateTime.now();
    final type = (apiResponse['type'] as String?) ?? '';
    final monitor = apiResponse['monitor'] != null ? VapiCallMonitor.fromJson(apiResponse['monitor'] as Map<String, dynamic>) : VapiCallMonitor.fromJson({});
    final transport = apiResponse['transport'] != null ? VapiCallTransport.fromJson(apiResponse['transport'] as Map<String, dynamic>) : VapiCallTransport.fromJson({});
    ...
    final assistantOverrides = overridesRaw != null
        ? Map<String, dynamic>.from(overridesRaw as Map)
        : <String, dynamic>{};
